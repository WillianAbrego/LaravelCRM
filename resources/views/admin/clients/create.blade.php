              ...
              <form method="POST" action="{{ route('admin.clients.store') }}">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="contact_phone_number" id="contact_phone_number"
                    ...
                    placeholder="Ingrese el teléfono del cliente" value="{{ old('contact_phone_number', '') }}">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="company_name" id="company_name"
                    ...
                    placeholder="Ingrese el nombre de la empresa" value="{{ old('company_name', '') }}">
                ...
                <div class="form-group">
                  <label for="company_email" class="required">Email de empresa </label>
                  <input type="email" name="company_email" id="company_email"
                    class="form-control {{ $errors->has('company_email') ? 'is-invalid' : '' }}"
                    placeholder="Ingrese el email de empresa" value="{{ old('company_email', '') }}">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="company_phone_number" id="company_phone_number"
                    ...
                    placeholder="Ingrese el teléfono de la empresa" value="{{ old('company_phone_number', '') }}">
